...
namespace KursovayaGUI {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->вопросыToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				this->среднееАрифметическоеУспешныхЗапусковToolStripMenuItem,
					this->какаяСамаяДешеваяРакетаДляЗапускаToolStripMenuItem, this->списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem,
					this->естьЛиОдинаковаяЦенаЗапускаУРазныхКомпанийToolStripMenuItem, this->алфавитныйСписокВсехКомпанийToolStripMenuItem, this->диаграммаПроцентноеСоотношениеВсехЗапусковКаждойКомпанииToolStripMenuItem
			});
			...
			// 
			// списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem
			// 
			this->списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem->Name = L"списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem";
			this->списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem->Size = System::Drawing::Size(472, 22);
			this->списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem->Text = L"Список ракет, у которых число удачных запусков больше X";
			this->списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem_Click);
			// 
...
private: System::Void открытьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	int i;
	char ctemp[80];
	char filePath[90] = "D:\\University\\прога\\курсач\\Kursovaya_GUI\\Kursovaya_GUI\\SpaceCompanies.dat";
	String^ s;
...
private: System::Void списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
