		...
		void InitializeComponent(void)
		{
			...
			this->вопросыToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				this->среднееАрифметическоеУспешныхЗапусковToolStripMenuItem,
					this->какаяСамаяДешеваяРакетаДляЗапускаToolStripMenuItem, this->размахРядаЦеныToolStripMenuItem,
			...
			// 
			this->размахРядаЦеныToolStripMenuItem->Name = L"списокРакетУКоторыхЧислоУдачныхЗапусковБольшеXToolStripMenuItem";
